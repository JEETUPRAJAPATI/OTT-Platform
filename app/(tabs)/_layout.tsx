...
import { Platform, View, Text, TouchableOpacity, StyleSheet, Modal, ScrollView, FlatList, TextInput, Alert, Animated, Dimensions, SafeAreaView } from 'react-native';
...
function CustomTabBar() {
  ...
  const [selectedSettingsTab, setSelectedSettingsTab] = useState<'favorites' | 'watchlist' | 'about' | 'privacy' | 'reviews' | null>(null);
  ...
  const settingsTabs = [
    ...
    { key: 'watchlist', label: 'Watchlist', icon: 'bookmark', color: '#8A2BE2' },
    { key: 'reviews', label: 'Reviews', icon: 'star', color: '#FFD700' },
    { key: 'about', label: 'About Us', icon: 'information-circle', color: '#32CD32' },
                  ...
                  >
                    <View style={styles.optionContent}>
                      <View style={styles.optionLeft}>
                        <View style={[styles.iconContainer, { backgroundColor: `${tab.color}20` }]}>
                          <Ionicons 
